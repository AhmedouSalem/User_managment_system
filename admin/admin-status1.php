			...
			<div class="row">
				<div class="col-sm-12">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item active">Commande accepté</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header">
						<h4 class="card-title">Nombre Des Commandes acceptées</h4>
			...
			<div class="modal-body">
				<form action="#" method="post" id="edit-note-form" class="px-3">
					...
					<div class="form-group">
						...
						<input type="text" id="nom" name="username" class="form-control" placeholder="Entrer Votre nom" disabled required>
					</div>
					<div class="form-group">
						<label for="prenom">Prenom Fournisseur :</label>
						<input type="text" id="prenom" name="lastname" class="form-control" placeholder="Entrer votre prénom" disabled required>
					</div>
					<!-- <div class="form-group">
					...
					<div class="form-group">
						...
						<select name="tel" id="tel" class="form-control" disabled>
							<option value="">Numéro de fournisseur</option>
						</select>
					</div>
					<!-- <div class="form-group">
					...
					<div class="form-group">
						<button disabled type="submit" name="editNote" id="editNoteBtn" class="btn btn-block btn-info">Modifier&nbsp;
...
<script src="assets/php/js/status1.js"></script>
