$(document).ready(function () {
	...
	function fetchAllUsers() {
		$.ajax({
			...
			method: 'post',
			data: { action: 'fetchCommandeStatus-1' },
	...
	$("body").on("click", ".userDetailsIcon", function (e) {
		e.preventDefault();
		detailsCommande_1_id = $(this).attr('id');
		$.ajax({
			url: 'assets/php/admin-action.php',
			method: 'post',
			data: { detailsCommande_1_id: detailsCommande_1_id },
			success: function (response) {
	...
	$("body").on("click", ".editBtn", function (e) {
		e.preventDefault();
		editCommande_1_id = $(this).attr('id');
		$.ajax({
			url: 'assets/php/admin-action.php',
			method: 'post',
			data: { editCommande_1_id: editCommande_1_id },
			success: function (response) {
				data = JSON.parse(response);
				$("#id").val(data.idc);
